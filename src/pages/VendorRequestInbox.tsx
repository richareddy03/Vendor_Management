...
export default function VendorRequestInbox({ showDetailsModal, setShowDetailsModal, selectedDetailsRequest, setSelectedDetailsRequest, resourceRequestsRef }) {
    ...
    <div className="space-y-6">
      ...
      <Dialog open={showDetailsModal} onOpenChange={setShowDetailsModal}>
        <DialogContent className="fixed inset-0 flex items-center justify-center bg-black/50 p-4 z-50">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-[700px] w-full max-h-[80vh] overflow-y-auto">
            <div className="relative">
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-800">Request Details</h3>
                <div className="grid grid-cols-2 gap-4 mt-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-base text-gray-900">{selectedDetailsRequest?.businessJustification || "N/A"}</p>
                  </div>
                </div>
              </div>
            </div>
